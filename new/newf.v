...
// Generated on: Feb 28 2025 18:53:34 IST (Feb 28 2025 13:23:34 UTC)
...
module fifo_empty(rd_clk, rd_en, rd_rst, wr_ptr_addr_sync, empty,
  ...
  inv0d0 g185(.I (n_16), .ZN (rd_addr_bin_next[4]));
  aoim22d1 g186__5107(.A1 (n_15), .A2 (n_10), .B1 (n_15), .B2 (n_10),
       .Z (n_16));
  xr02d1 g187__6260(.A1 (rd_addr_bin_next[3]), .A2
       (rd_addr_bin_next[2]), .Z (rd_addr_grey_next[2]));
  ah01d1 g188__4319(.A (n_14), .B (rd_addr_bin[3]), .CO (n_15), .S
       (rd_addr_bin_next[3]));
  dfcrq1 \rd_addr_grey_reg[1] (.CDN (rd_rst), .CP (rd_clk), .D
       (rd_addr_grey_next[1]), .Q (rd_addr_grey[1]));
  xr02d1 g190__8428(.A1 (rd_addr_bin_next[2]), .A2
       (rd_addr_bin_next[1]), .Z (rd_addr_grey_next[1]));
  ah01d1 g191__5526(.A (n_13), .B (rd_addr_bin[2]), .CO (n_14), .S
       (rd_addr_bin_next[2]));
  dfcrq1 \rd_addr_grey_reg[0] (.CDN (rd_rst), .CP (rd_clk), .D
       (rd_addr_grey_next[0]), .Q (rd_addr_grey[0]));
  xr02d1 g193__6783(.A1 (rd_addr_bin_next[1]), .A2
       (rd_addr_bin_next[0]), .Z (rd_addr_grey_next[0]));
  ah01d1 g194__3680(.A (n_12), .B (rd_addr_bin[1]), .CO (n_13), .S
       (rd_addr_bin_next[1]));
  ah01d1 g195__1617(.A (n_11), .B (rd_addr_bin[0]), .CO (n_12), .S
       (rd_addr_bin_next[0]));
  nr02d1 g196__2802(.A1 (empty), .A2 (n_17), .ZN (n_11));
  dfprb1 empty_r_reg(.SDN (rd_rst), .CP (rd_clk), .D (n_9), .Q (empty),
       .QN (UNCONNECTED));
  oan211d1 g198__1705(.A (n_8), .B (n_3), .C1 (rd_addr_bin_next[4]),
       .C2 (wr_ptr_addr_sync[4]), .ZN (n_9));
  nd04d1 g199__5122(.A1 (n_5), .A2 (n_7), .A3 (n_4), .A4 (n_6), .ZN
       (n_8));
  oaim22d1 g200__8246(.A1 (rd_addr_grey_next[3]), .A2
       (wr_ptr_addr_sync[3]), .B1 (rd_addr_grey_next[3]), .B2
       (wr_ptr_addr_sync[3]), .ZN (n_7));
  aoim22d1 g201__7098(.A1 (rd_addr_grey_next[0]), .A2 (n_1), .B1
       (rd_addr_grey_next[0]), .B2 (n_1), .Z (n_6));
  aoim22d1 g202__6131(.A1 (rd_addr_grey_next[1]), .A2 (n_2), .B1
       (rd_addr_grey_next[1]), .B2 (n_2), .Z (n_5));
  aoim22d1 g203__1881(.A1 (rd_addr_grey_next[2]), .A2 (n_0), .B1
  ...
  nd02d1 g207__5115(.A1 (rd_addr_bin_next[4]), .A2
       (wr_ptr_addr_sync[4]), .ZN (n_3));
  inv0d0 g208(.I (wr_ptr_addr_sync[1]), .ZN (n_2));
  inv0d0 g209(.I (wr_ptr_addr_sync[0]), .ZN (n_1));
  inv0d0 g210(.I (wr_ptr_addr_sync[2]), .ZN (n_0));
...
module fifo_memory(clk, rst, wr_en, full, wr_addr, rd_addr, wr_data,
  ...
  decrq1 \mem_reg[0][0] (.CDN (rst), .CP (rst), .D (wr_data[0]), .ENN
       (n_20), .Q (\mem[0] [0]));
  decrq1 \mem_reg[0][1] (.CDN (rst), .CP (rst), .D (wr_data[1]), .ENN
       (n_20), .Q (\mem[0] [1]));
  decrq1 \mem_reg[0][2] (.CDN (rst), .CP (rst), .D (wr_data[2]), .ENN
       (n_20), .Q (\mem[0] [2]));
  decrq1 \mem_reg[0][3] (.CDN (rst), .CP (rst), .D (wr_data[3]), .ENN
       (n_20), .Q (\mem[0] [3]));
  decrq1 \mem_reg[0][4] (.CDN (rst), .CP (rst), .D (wr_data[4]), .ENN
       (n_20), .Q (\mem[0] [4]));
  decrq1 \mem_reg[0][5] (.CDN (rst), .CP (rst), .D (wr_data[5]), .ENN
       (n_20), .Q (\mem[0] [5]));
  decrq1 \mem_reg[0][6] (.CDN (rst), .CP (rst), .D (wr_data[6]), .ENN
       (n_20), .Q (\mem[0] [6]));
  decrq1 \mem_reg[0][7] (.CDN (rst), .CP (rst), .D (wr_data[7]), .ENN
       (n_20), .Q (\mem[0] [7]));
  decrq1 \mem_reg[1][0] (.CDN (rst), .CP (rst), .D (wr_data[0]), .ENN
       (n_28), .Q (\mem[1] [0]));
  decrq1 \mem_reg[1][1] (.CDN (rst), .CP (rst), .D (wr_data[1]), .ENN
       (n_28), .Q (\mem[1] [1]));
  decrq1 \mem_reg[1][2] (.CDN (rst), .CP (rst), .D (wr_data[2]), .ENN
       (n_28), .Q (\mem[1] [2]));
  decrq1 \mem_reg[1][3] (.CDN (rst), .CP (rst), .D (wr_data[3]), .ENN
       (n_28), .Q (\mem[1] [3]));
  decrq1 \mem_reg[1][4] (.CDN (rst), .CP (rst), .D (wr_data[4]), .ENN
       (n_28), .Q (\mem[1] [4]));
  decrq1 \mem_reg[1][5] (.CDN (rst), .CP (rst), .D (wr_data[5]), .ENN
       (n_28), .Q (\mem[1] [5]));
  decrq1 \mem_reg[1][6] (.CDN (rst), .CP (rst), .D (wr_data[6]), .ENN
       (n_28), .Q (\mem[1] [6]));
  decrq1 \mem_reg[1][7] (.CDN (rst), .CP (rst), .D (wr_data[7]), .ENN
       (n_28), .Q (\mem[1] [7]));
  decrq1 \mem_reg[2][0] (.CDN (rst), .CP (rst), .D (wr_data[0]), .ENN
       (n_27), .Q (\mem[2] [0]));
  decrq1 \mem_reg[2][1] (.CDN (rst), .CP (rst), .D (wr_data[1]), .ENN
       (n_27), .Q (\mem[2] [1]));
  decrq1 \mem_reg[2][2] (.CDN (rst), .CP (rst), .D (wr_data[2]), .ENN
       (n_27), .Q (\mem[2] [2]));
  decrq1 \mem_reg[2][3] (.CDN (rst), .CP (rst), .D (wr_data[3]), .ENN
       (n_27), .Q (\mem[2] [3]));
  decrq1 \mem_reg[2][4] (.CDN (rst), .CP (rst), .D (wr_data[4]), .ENN
       (n_27), .Q (\mem[2] [4]));
  decrq1 \mem_reg[2][5] (.CDN (rst), .CP (rst), .D (wr_data[5]), .ENN
       (n_27), .Q (\mem[2] [5]));
  decrq1 \mem_reg[2][6] (.CDN (rst), .CP (rst), .D (wr_data[6]), .ENN
       (n_27), .Q (\mem[2] [6]));
  decrq1 \mem_reg[2][7] (.CDN (rst), .CP (rst), .D (wr_data[7]), .ENN
       (n_27), .Q (\mem[2] [7]));
  decrq1 \mem_reg[3][0] (.CDN (rst), .CP (rst), .D (wr_data[0]), .ENN
       (n_25), .Q (\mem[3] [0]));
  decrq1 \mem_reg[3][1] (.CDN (rst), .CP (rst), .D (wr_data[1]), .ENN
       (n_25), .Q (\mem[3] [1]));
  decrq1 \mem_reg[3][2] (.CDN (rst), .CP (rst), .D (wr_data[2]), .ENN
       (n_25), .Q (\mem[3] [2]));
  decrq1 \mem_reg[3][3] (.CDN (rst), .CP (rst), .D (wr_data[3]), .ENN
       (n_25), .Q (\mem[3] [3]));
  decrq1 \mem_reg[3][4] (.CDN (rst), .CP (rst), .D (wr_data[4]), .ENN
       (n_25), .Q (\mem[3] [4]));
  decrq1 \mem_reg[3][5] (.CDN (rst), .CP (rst), .D (wr_data[5]), .ENN
       (n_25), .Q (\mem[3] [5]));
  decrq1 \mem_reg[3][6] (.CDN (rst), .CP (rst), .D (wr_data[6]), .ENN
       (n_25), .Q (\mem[3] [6]));
  decrq1 \mem_reg[3][7] (.CDN (rst), .CP (rst), .D (wr_data[7]), .ENN
       (n_25), .Q (\mem[3] [7]));
  decrq1 \mem_reg[4][0] (.CDN (rst), .CP (rst), .D (wr_data[0]), .ENN
       (n_21), .Q (\mem[4] [0]));
  decrq1 \mem_reg[4][1] (.CDN (rst), .CP (rst), .D (wr_data[1]), .ENN
       (n_21), .Q (\mem[4] [1]));
  decrq1 \mem_reg[4][2] (.CDN (rst), .CP (rst), .D (wr_data[2]), .ENN
       (n_21), .Q (\mem[4] [2]));
  decrq1 \mem_reg[4][3] (.CDN (rst), .CP (rst), .D (wr_data[3]), .ENN
       (n_21), .Q (\mem[4] [3]));
  decrq1 \mem_reg[4][4] (.CDN (rst), .CP (rst), .D (wr_data[4]), .ENN
       (n_21), .Q (\mem[4] [4]));
  decrq1 \mem_reg[4][5] (.CDN (rst), .CP (rst), .D (wr_data[5]), .ENN
       (n_21), .Q (\mem[4] [5]));
  decrq1 \mem_reg[4][6] (.CDN (rst), .CP (rst), .D (wr_data[6]), .ENN
       (n_21), .Q (\mem[4] [6]));
  decrq1 \mem_reg[4][7] (.CDN (rst), .CP (rst), .D (wr_data[7]), .ENN
       (n_21), .Q (\mem[4] [7]));
  decrq1 \mem_reg[5][0] (.CDN (rst), .CP (rst), .D (wr_data[0]), .ENN
       (n_17), .Q (\mem[5] [0]));
  decrq1 \mem_reg[5][1] (.CDN (rst), .CP (rst), .D (wr_data[1]), .ENN
       (n_17), .Q (\mem[5] [1]));
  decrq1 \mem_reg[5][2] (.CDN (rst), .CP (rst), .D (wr_data[2]), .ENN
       (n_17), .Q (\mem[5] [2]));
  decrq1 \mem_reg[5][3] (.CDN (rst), .CP (rst), .D (wr_data[3]), .ENN
       (n_17), .Q (\mem[5] [3]));
  decrq1 \mem_reg[5][4] (.CDN (rst), .CP (rst), .D (wr_data[4]), .ENN
       (n_17), .Q (\mem[5] [4]));
  decrq1 \mem_reg[5][5] (.CDN (rst), .CP (rst), .D (wr_data[5]), .ENN
       (n_17), .Q (\mem[5] [5]));
  decrq1 \mem_reg[5][6] (.CDN (rst), .CP (rst), .D (wr_data[6]), .ENN
       (n_17), .Q (\mem[5] [6]));
  decrq1 \mem_reg[5][7] (.CDN (rst), .CP (rst), .D (wr_data[7]), .ENN
       (n_17), .Q (\mem[5] [7]));
  decrq1 \mem_reg[6][0] (.CDN (rst), .CP (rst), .D (wr_data[0]), .ENN
       (n_31), .Q (\mem[6] [0]));
  decrq1 \mem_reg[6][1] (.CDN (rst), .CP (rst), .D (wr_data[1]), .ENN
       (n_31), .Q (\mem[6] [1]));
  decrq1 \mem_reg[6][2] (.CDN (rst), .CP (rst), .D (wr_data[2]), .ENN
       (n_31), .Q (\mem[6] [2]));
  decrq1 \mem_reg[6][3] (.CDN (rst), .CP (rst), .D (wr_data[3]), .ENN
       (n_31), .Q (\mem[6] [3]));
  decrq1 \mem_reg[6][4] (.CDN (rst), .CP (rst), .D (wr_data[4]), .ENN
       (n_31), .Q (\mem[6] [4]));
  decrq1 \mem_reg[6][5] (.CDN (rst), .CP (rst), .D (wr_data[5]), .ENN
       (n_31), .Q (\mem[6] [5]));
  decrq1 \mem_reg[6][6] (.CDN (rst), .CP (rst), .D (wr_data[6]), .ENN
       (n_31), .Q (\mem[6] [6]));
  decrq1 \mem_reg[6][7] (.CDN (rst), .CP (rst), .D (wr_data[7]), .ENN
       (n_31), .Q (\mem[6] [7]));
  decrq1 \mem_reg[7][0] (.CDN (rst), .CP (rst), .D (wr_data[0]), .ENN
       (n_29), .Q (\mem[7] [0]));
  decrq1 \mem_reg[7][1] (.CDN (rst), .CP (rst), .D (wr_data[1]), .ENN
       (n_29), .Q (\mem[7] [1]));
  decrq1 \mem_reg[7][2] (.CDN (rst), .CP (rst), .D (wr_data[2]), .ENN
       (n_29), .Q (\mem[7] [2]));
  decrq1 \mem_reg[7][3] (.CDN (rst), .CP (rst), .D (wr_data[3]), .ENN
       (n_29), .Q (\mem[7] [3]));
  decrq1 \mem_reg[7][4] (.CDN (rst), .CP (rst), .D (wr_data[4]), .ENN
       (n_29), .Q (\mem[7] [4]));
  decrq1 \mem_reg[7][5] (.CDN (rst), .CP (rst), .D (wr_data[5]), .ENN
       (n_29), .Q (\mem[7] [5]));
  decrq1 \mem_reg[7][6] (.CDN (rst), .CP (rst), .D (wr_data[6]), .ENN
       (n_29), .Q (\mem[7] [6]));
  decrq1 \mem_reg[7][7] (.CDN (rst), .CP (rst), .D (wr_data[7]), .ENN
       (n_29), .Q (\mem[7] [7]));
  decrq1 \mem_reg[8][0] (.CDN (rst), .CP (rst), .D (wr_data[0]), .ENN
       (n_32), .Q (\mem[8] [0]));
  decrq1 \mem_reg[8][1] (.CDN (rst), .CP (rst), .D (wr_data[1]), .ENN
       (n_32), .Q (\mem[8] [1]));
  decrq1 \mem_reg[8][2] (.CDN (rst), .CP (rst), .D (wr_data[2]), .ENN
       (n_32), .Q (\mem[8] [2]));
  decrq1 \mem_reg[8][3] (.CDN (rst), .CP (rst), .D (wr_data[3]), .ENN
       (n_32), .Q (\mem[8] [3]));
  decrq1 \mem_reg[8][4] (.CDN (rst), .CP (rst), .D (wr_data[4]), .ENN
       (n_32), .Q (\mem[8] [4]));
  decrq1 \mem_reg[8][5] (.CDN (rst), .CP (rst), .D (wr_data[5]), .ENN
       (n_32), .Q (\mem[8] [5]));
  decrq1 \mem_reg[8][6] (.CDN (rst), .CP (rst), .D (wr_data[6]), .ENN
       (n_32), .Q (\mem[8] [6]));
  decrq1 \mem_reg[8][7] (.CDN (rst), .CP (rst), .D (wr_data[7]), .ENN
       (n_32), .Q (\mem[8] [7]));
  decrq1 \mem_reg[9][0] (.CDN (rst), .CP (rst), .D (wr_data[0]), .ENN
       (n_23), .Q (\mem[9] [0]));
  decrq1 \mem_reg[9][1] (.CDN (rst), .CP (rst), .D (wr_data[1]), .ENN
       (n_23), .Q (\mem[9] [1]));
  decrq1 \mem_reg[9][2] (.CDN (rst), .CP (rst), .D (wr_data[2]), .ENN
       (n_23), .Q (\mem[9] [2]));
  decrq1 \mem_reg[9][3] (.CDN (rst), .CP (rst), .D (wr_data[3]), .ENN
       (n_23), .Q (\mem[9] [3]));
  decrq1 \mem_reg[9][4] (.CDN (rst), .CP (rst), .D (wr_data[4]), .ENN
       (n_23), .Q (\mem[9] [4]));
  decrq1 \mem_reg[9][5] (.CDN (rst), .CP (rst), .D (wr_data[5]), .ENN
       (n_23), .Q (\mem[9] [5]));
  decrq1 \mem_reg[9][6] (.CDN (rst), .CP (rst), .D (wr_data[6]), .ENN
       (n_23), .Q (\mem[9] [6]));
  decrq1 \mem_reg[9][7] (.CDN (rst), .CP (rst), .D (wr_data[7]), .ENN
       (n_23), .Q (\mem[9] [7]));
  decrq1 \mem_reg[10][0] (.CDN (rst), .CP (rst), .D (wr_data[0]), .ENN
       (n_19), .Q (\mem[10] [0]));
  decrq1 \mem_reg[10][1] (.CDN (rst), .CP (rst), .D (wr_data[1]), .ENN
       (n_19), .Q (\mem[10] [1]));
  decrq1 \mem_reg[10][2] (.CDN (rst), .CP (rst), .D (wr_data[2]), .ENN
       (n_19), .Q (\mem[10] [2]));
  decrq1 \mem_reg[10][3] (.CDN (rst), .CP (rst), .D (wr_data[3]), .ENN
       (n_19), .Q (\mem[10] [3]));
  decrq1 \mem_reg[10][4] (.CDN (rst), .CP (rst), .D (wr_data[4]), .ENN
       (n_19), .Q (\mem[10] [4]));
  decrq1 \mem_reg[10][5] (.CDN (rst), .CP (rst), .D (wr_data[5]), .ENN
       (n_19), .Q (\mem[10] [5]));
  decrq1 \mem_reg[10][6] (.CDN (rst), .CP (rst), .D (wr_data[6]), .ENN
       (n_19), .Q (\mem[10] [6]));
  decrq1 \mem_reg[10][7] (.CDN (rst), .CP (rst), .D (wr_data[7]), .ENN
       (n_19), .Q (\mem[10] [7]));
  decrq1 \mem_reg[11][0] (.CDN (rst), .CP (rst), .D (wr_data[0]), .ENN
       (n_24), .Q (\mem[11] [0]));
  decrq1 \mem_reg[11][1] (.CDN (rst), .CP (rst), .D (wr_data[1]), .ENN
       (n_24), .Q (\mem[11] [1]));
  decrq1 \mem_reg[11][2] (.CDN (rst), .CP (rst), .D (wr_data[2]), .ENN
       (n_24), .Q (\mem[11] [2]));
  decrq1 \mem_reg[11][3] (.CDN (rst), .CP (rst), .D (wr_data[3]), .ENN
       (n_24), .Q (\mem[11] [3]));
  decrq1 \mem_reg[11][4] (.CDN (rst), .CP (rst), .D (wr_data[4]), .ENN
       (n_24), .Q (\mem[11] [4]));
  decrq1 \mem_reg[11][5] (.CDN (rst), .CP (rst), .D (wr_data[5]), .ENN
       (n_24), .Q (\mem[11] [5]));
  decrq1 \mem_reg[11][6] (.CDN (rst), .CP (rst), .D (wr_data[6]), .ENN
       (n_24), .Q (\mem[11] [6]));
  decrq1 \mem_reg[11][7] (.CDN (rst), .CP (rst), .D (wr_data[7]), .ENN
       (n_24), .Q (\mem[11] [7]));
  decrq1 \mem_reg[12][0] (.CDN (rst), .CP (rst), .D (wr_data[0]), .ENN
       (n_30), .Q (\mem[12] [0]));
  decrq1 \mem_reg[12][1] (.CDN (rst), .CP (rst), .D (wr_data[1]), .ENN
       (n_30), .Q (\mem[12] [1]));
  decrq1 \mem_reg[12][2] (.CDN (rst), .CP (rst), .D (wr_data[2]), .ENN
       (n_30), .Q (\mem[12] [2]));
  decrq1 \mem_reg[12][3] (.CDN (rst), .CP (rst), .D (wr_data[3]), .ENN
       (n_30), .Q (\mem[12] [3]));
  decrq1 \mem_reg[12][4] (.CDN (rst), .CP (rst), .D (wr_data[4]), .ENN
       (n_30), .Q (\mem[12] [4]));
  decrq1 \mem_reg[12][5] (.CDN (rst), .CP (rst), .D (wr_data[5]), .ENN
       (n_30), .Q (\mem[12] [5]));
  decrq1 \mem_reg[12][6] (.CDN (rst), .CP (rst), .D (wr_data[6]), .ENN
       (n_30), .Q (\mem[12] [6]));
  decrq1 \mem_reg[12][7] (.CDN (rst), .CP (rst), .D (wr_data[7]), .ENN
       (n_30), .Q (\mem[12] [7]));
  decrq1 \mem_reg[13][0] (.CDN (rst), .CP (rst), .D (wr_data[0]), .ENN
       (n_26), .Q (\mem[13] [0]));
  decrq1 \mem_reg[13][1] (.CDN (rst), .CP (rst), .D (wr_data[1]), .ENN
       (n_26), .Q (\mem[13] [1]));
  decrq1 \mem_reg[13][2] (.CDN (rst), .CP (rst), .D (wr_data[2]), .ENN
       (n_26), .Q (\mem[13] [2]));
  decrq1 \mem_reg[13][3] (.CDN (rst), .CP (rst), .D (wr_data[3]), .ENN
       (n_26), .Q (\mem[13] [3]));
  decrq1 \mem_reg[13][4] (.CDN (rst), .CP (rst), .D (wr_data[4]), .ENN
       (n_26), .Q (\mem[13] [4]));
  decrq1 \mem_reg[13][5] (.CDN (rst), .CP (rst), .D (wr_data[5]), .ENN
       (n_26), .Q (\mem[13] [5]));
  decrq1 \mem_reg[13][6] (.CDN (rst), .CP (rst), .D (wr_data[6]), .ENN
       (n_26), .Q (\mem[13] [6]));
  decrq1 \mem_reg[13][7] (.CDN (rst), .CP (rst), .D (wr_data[7]), .ENN
       (n_26), .Q (\mem[13] [7]));
  decrq1 \mem_reg[14][0] (.CDN (rst), .CP (rst), .D (wr_data[0]), .ENN
       (n_18), .Q (\mem[14] [0]));
  decrq1 \mem_reg[14][1] (.CDN (rst), .CP (rst), .D (wr_data[1]), .ENN
       (n_18), .Q (\mem[14] [1]));
  decrq1 \mem_reg[14][2] (.CDN (rst), .CP (rst), .D (wr_data[2]), .ENN
       (n_18), .Q (\mem[14] [2]));
  decrq1 \mem_reg[14][3] (.CDN (rst), .CP (rst), .D (wr_data[3]), .ENN
       (n_18), .Q (\mem[14] [3]));
  decrq1 \mem_reg[14][4] (.CDN (rst), .CP (rst), .D (wr_data[4]), .ENN
       (n_18), .Q (\mem[14] [4]));
  decrq1 \mem_reg[14][5] (.CDN (rst), .CP (rst), .D (wr_data[5]), .ENN
       (n_18), .Q (\mem[14] [5]));
  decrq1 \mem_reg[14][6] (.CDN (rst), .CP (rst), .D (wr_data[6]), .ENN
       (n_18), .Q (\mem[14] [6]));
  decrq1 \mem_reg[14][7] (.CDN (rst), .CP (rst), .D (wr_data[7]), .ENN
       (n_18), .Q (\mem[14] [7]));
  decrq1 \mem_reg[15][0] (.CDN (rst), .CP (rst), .D (wr_data[0]), .ENN
       (n_22), .Q (\mem[15] [0]));
  decrq1 \mem_reg[15][1] (.CDN (rst), .CP (rst), .D (wr_data[1]), .ENN
       (n_22), .Q (\mem[15] [1]));
  decrq1 \mem_reg[15][2] (.CDN (rst), .CP (rst), .D (wr_data[2]), .ENN
       (n_22), .Q (\mem[15] [2]));
  decrq1 \mem_reg[15][3] (.CDN (rst), .CP (rst), .D (wr_data[3]), .ENN
       (n_22), .Q (\mem[15] [3]));
  decrq1 \mem_reg[15][4] (.CDN (rst), .CP (rst), .D (wr_data[4]), .ENN
       (n_22), .Q (\mem[15] [4]));
  decrq1 \mem_reg[15][5] (.CDN (rst), .CP (rst), .D (wr_data[5]), .ENN
       (n_22), .Q (\mem[15] [5]));
  decrq1 \mem_reg[15][6] (.CDN (rst), .CP (rst), .D (wr_data[6]), .ENN
       (n_22), .Q (\mem[15] [6]));
  decrq1 \mem_reg[15][7] (.CDN (rst), .CP (rst), .D (wr_data[7]), .ENN
       (n_22), .Q (\mem[15] [7]));
  or02d1 g1967__6417(.A1 (n_0), .A2 (wr_addr[0]), .Z (n_32));
  nd02d1 g1968__5477(.A1 (n_16), .A2 (n_1), .ZN (n_31));
  or02d1 g1969__2398(.A1 (n_13), .A2 (wr_addr[0]), .Z (n_30));
  nd02d1 g1970__5107(.A1 (n_16), .A2 (wr_addr[0]), .ZN (n_29));
  nd02d1 g1971__6260(.A1 (n_10), .A2 (wr_addr[0]), .ZN (n_28));
  nd02d1 g1972__4319(.A1 (n_15), .A2 (n_1), .ZN (n_27));
  nd12d1 g1973__8428(.A1 (n_13), .A2 (wr_addr[0]), .ZN (n_26));
  nd02d1 g1974__5526(.A1 (n_15), .A2 (wr_addr[0]), .ZN (n_25));
  nd02d1 g1975__6783(.A1 (n_14), .A2 (wr_addr[0]), .ZN (n_24));
  nd12d1 g1976__3680(.A1 (n_0), .A2 (wr_addr[0]), .ZN (n_23));
  nd02d1 g1977__1617(.A1 (n_11), .A2 (wr_addr[0]), .ZN (n_22));
  nd02d1 g1978__2802(.A1 (n_12), .A2 (n_1), .ZN (n_21));
  nd02d1 g1979__1705(.A1 (n_10), .A2 (n_1), .ZN (n_20));
  nd02d1 g1980__5122(.A1 (n_14), .A2 (n_1), .ZN (n_19));
  nd02d1 g1981__8246(.A1 (n_11), .A2 (n_1), .ZN (n_18));
  nd02d1 g1982__7098(.A1 (n_12), .A2 (wr_addr[0]), .ZN (n_17));
  nr02d1 g1983__6131(.A1 (wr_addr[3]), .A2 (n_9), .ZN (n_16));
  nr02d1 g1984__1881(.A1 (wr_addr[3]), .A2 (n_8), .ZN (n_15));
  nr02d1 g1985__5115(.A1 (n_2), .A2 (n_8), .ZN (n_14));
  nd02d1 g1986__7482(.A1 (n_7), .A2 (wr_addr[3]), .ZN (n_13));
  an02d1 g1988__4733(.A1 (n_7), .A2 (n_2), .Z (n_12));
  nr02d1 g1989__6161(.A1 (n_2), .A2 (n_9), .ZN (n_11));
  nr02d1 g1990__9315(.A1 (wr_addr[3]), .A2 (n_6), .ZN (n_10));
  nd12d1 g1991__9945(.A1 (n_5), .A2 (wr_addr[1]), .ZN (n_9));
  nd02d1 g1992__2883(.A1 (n_4), .A2 (wr_addr[1]), .ZN (n_8));
  nr02d1 g1994__2346(.A1 (wr_addr[1]), .A2 (n_5), .ZN (n_7));
  nd12d1 g1995__1666(.A1 (wr_addr[1]), .A2 (n_4), .ZN (n_6));
  nd12d1 g1996__7410(.A1 (n_3), .A2 (wr_addr[2]), .ZN (n_5));
  nr02d1 g1997__6417(.A1 (wr_addr[2]), .A2 (n_3), .ZN (n_4));
  nd12d1 g1998__5477(.A1 (full), .A2 (wr_en), .ZN (n_3));
  inv0d0 g1999(.I (wr_addr[3]), .ZN (n_2));
  inv0d0 g2000(.I (wr_addr[0]), .ZN (n_1));
  nd12d1 g2__2398(.A1 (n_6), .A2 (wr_addr[3]), .ZN (n_0));
endmodule

module dff_3_32(clk, rst, wr_data, rd_data);
  input clk, rst;
  input [4:0] wr_data;
  output [4:0] rd_data;
  wire clk, rst;
...
module dff_3(clk, rst, wr_data, rd_data);
  input clk, rst;
  input [4:0] wr_data;
  output [4:0] rd_data;
  wire clk, rst;
...
module cdc_synchronizer_1(clk, rst, in_data, out_data);
  input clk, rst;
  input [4:0] in_data;
  output [4:0] out_data;
  wire clk, rst;
  ...
  wire [4:0] out_data;
  wire [4:0] in_data_n;
  dff_3_32 dff_1(.clk (clk), .rst (rst), .wr_data (in_data), .rd_data
       (in_data_n));
  dff_3 dff_2(.clk (clk), .rst (rst), .wr_data (in_data_n), .rd_data
       (out_data));
endmodule
...
module dff(clk, rst, wr_data, rd_data);
  ...
  wire [4:0] wr_data;
  wire [4:0] rd_data;
  dfcrq1 \rd_data_reg[4] (.CDN (rst), .CP (rst), .D (wr_data[4]), .Q
       (rd_data[4]));
  dfcrq1 \rd_data_reg[3] (.CDN (rst), .CP (rst), .D (wr_data[3]), .Q
       (rd_data[3]));
  dfcrq1 \rd_data_reg[1] (.CDN (rst), .CP (rst), .D (wr_data[1]), .Q
       (rd_data[1]));
  dfcrq1 \rd_data_reg[2] (.CDN (rst), .CP (rst), .D (wr_data[2]), .Q
       (rd_data[2]));
  dfcrq1 \rd_data_reg[0] (.CDN (rst), .CP (rst), .D (wr_data[0]), .Q
       (rd_data[0]));
endmodule

module dff_31(clk, rst, wr_data, rd_data);
  input clk, rst;
  input [4:0] wr_data;
  output [4:0] rd_data;
  wire clk, rst;
...
module cdc_synchronizer(clk, rst, in_data, out_data);
  ...
  dff dff_1(UNCONNECTED_HIER_Z, rst, in_data, in_data_n);
  dff_31 dff_2(UNCONNECTED_HIER_Z0, rst, in_data_n, out_data);
endmodule
...
module fifo_top(wr_clk_pad, rd_clk_pad, wr_en_pad, rd_en_pad,
  ...
  wire [7:0] wr_data;
  wire [7:0] rd_data;
  wire UNCONNECTED_HIER_Z1, UNCONNECTED_HIER_Z2, empty, full, rd_clk,
       rd_en, rd_rst, read_clk;
  wire wr_clk, wr_en, wr_rst, write_clk;
  fifo_empty e(rd_clk, rd_en, rd_rst, wr_addr_grey_sync, empty,
       rd_addr_grey, rd_addr);
  fifo_full f(wr_clk, wr_en, wr_rst, rd_addr_grey_sync, full,
       wr_addr_grey, wr_addr);
  fifo_memory m(UNCONNECTED_HIER_Z1, wr_clk, wr_en, full, wr_addr,
       rd_addr, wr_data, rd_data);
  cdc_synchronizer_1 rd_addr_sync(rd_clk, rd_rst, wr_addr_grey,
       wr_addr_grey_sync);
  cdc_synchronizer wr_addr_sync(UNCONNECTED_HIER_Z2, wr_clk,
       rd_addr_grey, rd_addr_grey_sync);
